...
#define USB_CFG_DEVICE_VERSION  0x00, 0x02
	 ...
	 */
#define USB_CFG_VENDOR_NAME     's','t','r','a','w','-','s','o','l','u','t','i','o','n','s','.','c','z'
...
#define USB_CFG_DEVICE_NAME     'T', 'i', 'm', 'e', 's', ' ', 'M', 'a', 'c', 'h', 'i', 'n', 'e', ' ', 'L', 'i', 'g', 'h', 't', ' ', 'b', 'a', 'r', 'r', 'i', 'e', 'r'
